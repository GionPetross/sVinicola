...
<body>
	...
	<main>
		...
		%>
			<div class="success-message-global" style="max-width: 500px; margin: 20px auto;"><%= messaggioSuccesso %></div>
		<%
			} else if (messaggioErrore != null) {
		%>
			<div class="error-message-global" style="max-width: 500px; margin: 20px auto;"><%= messaggioErrore %></div>
		<%
			}
		%>
